...
public func log(message: String = "", file: String = #file, function: String = #function, lineNum: Int = __LINE__) {
...
public func RuntimeException(message: String = "", file: String = #file, function: String = #function, lineNum: Int = __LINE__) {
    // #if DEBUG
